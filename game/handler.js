...
class Handler{
    ...
    handleLobbyCommand(client, packet){
        switch(packet.command) {
            ...
            case "chance_wheel":
                ...
                break;
            case "get_medals":
                this.handleMedalCollec(client, packet);
                break;
            case "get_medals":
                this.handleShowMedalCollection(client, packet);
                break;    
            case "xpromo_fetch":
                this.handleSetXPromoPopup(client, packet);
                break;
            case "news":
                this.handleShowNewsPopUp(client, packet);
                break;   
            case "change_pet":
            ...
            case "buy_accessory":
                ...
                break;
            case "idlegift":
                this.handleClaimIdleGift(client, packet);
                break;    
            case "set_acc_load":
    ...
    handleShowMedalCollection(client, data){
        if(client.connectionType == "lobby") {
            client.sendPacket
            (
                {
    ...
    handleSetXPromoPopup(client, data){
        if(client.connectionType == "lobby") {
            client.sendPacket
            (
                {
                    "command": "xpromo_fetched"
                }
            );
        }
    }
    
    handleShowNewsPopUp(client, data){
         if(client.connectionType == "lobby") {
            client.sendPacket
            (
                {
    ...
    handleClaimIdleGift(client, data){
         if(client.connectionType == "lobby") {
            client.sendPacket
            (
                {
